...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF5100D9);

  // Secondary colors
  static const Color secondary = Color(0xFF03DAC6);
  static const Color secondaryLight = Color(0xFF66F9FF);
  static const Color secondaryDark = Color(0xFF00B8A9);

  // Accent colors
  static const Color accent = Color(0xFFFF6B6B);
  static const Color accentLight = Color(0xFFFF8A8A);
  static const Color accentDark = Color(0xFFEE5A4A);
  ...
  static const Color errorDark = Color(0xFF800015);
